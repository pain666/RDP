...
set_target_properties(winpr PROPERTIES
  IMPORTED_IMPLIB_MINSIZEREL "${_IMPORT_PREFIX}/lib/winpr2.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_MINSIZEREL "ntdsapi;C:/OpenSSL-Win32/lib/libssl.lib;C:/OpenSSL-Win32/lib/libcrypto.lib;crypt32;Dbghelp;ws2_32;rpcrt4;credui;Shlwapi"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/lib/winpr2.dll"
  )
...
# Import target "winpr-tools" for configuration "MinSizeRel"
set_property(TARGET winpr-tools APPEND PROPERTY IMPORTED_CONFIGURATIONS MINSIZEREL)
set_target_properties(winpr-tools PROPERTIES
  IMPORTED_IMPLIB_MINSIZEREL "${_IMPORT_PREFIX}/lib/winpr-tools2.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "winpr"
  IMPORTED_LINK_INTERFACE_LIBRARIES_MINSIZEREL ""
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/lib/winpr-tools2.dll"
  )
...
# Import target "winpr-makecert" for configuration "MinSizeRel"
set_property(TARGET winpr-makecert APPEND PROPERTY IMPORTED_CONFIGURATIONS MINSIZEREL)
set_target_properties(winpr-makecert PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/winpr-makecert.exe"
  )
...
# Import target "winpr-hash" for configuration "MinSizeRel"
set_property(TARGET winpr-hash APPEND PROPERTY IMPORTED_CONFIGURATIONS MINSIZEREL)
set_target_properties(winpr-hash PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/winpr-hash.exe"
  )
